 ...
 * 
 */
@WebServiceClient(name = "SOAPWebServiceService", targetNamespace = "http://soap.com/", wsdlLocation = "http://localhost:9000/SOAPWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPWEBSERVICESERVICE_QNAME = new QName("http://soap.com/", "SOAPWebServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9000/SOAPWebService?wsdl");
    ...
    public SOAPWebService getSOAPWebServicePort() {
        return super.getPort(new QName("http://soap.com/", "SOAPWebServicePort"), SOAPWebService.class);
    }
    ...
    public SOAPWebService getSOAPWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.com/", "SOAPWebServicePort"), SOAPWebService.class, features);
    }
